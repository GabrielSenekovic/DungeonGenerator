...
{
    public bool fillInventoryWithRandomItems_in;
    public static bool fillInventoryWithRandomItems;
    ...
    private void Awake() 
    {
        fillInventoryWithRandomItems = fillInventoryWithRandomItems_in;
